...
dotnet publish StaticWebsite/StaticWebsite.csproj -c Release
echo "Project built successfully."

# Verify index.html exists
if [ ! -f StaticWebsite/bin/Release/net9.0/publish/wwwroot/index.html ]; then
...
cp -r StaticWebsite/bin/Release/net9.0/publish/wwwroot/* build/wwwroot/
